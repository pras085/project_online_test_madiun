...
import '../pages/groupsoal.dart';

class GridGroupSoal extends StatefulWidget {
  GridGroupSoal(this._postsx, {Key? key}) : super(key: key);
  late final List _postsx;
  @override
  _GridGroupSoalState createState() => _GridGroupSoalState();
}

class _GridGroupSoalState extends State<GridGroupSoal> {
  @override
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () => Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => jenis == 'soal' ? GroupSoal() : Text('nilai'),
        ),
      ),
    );
  }
