...
import '../_helper/gridmapel.dart';

class MateriMapel extends StatefulWidget {
  MateriMapel(this.materi, {Key? key}) : super(key: key);
  String materi;
  @override
  State<MateriMapel> createState() => _MateriMapelState();
}

class _MateriMapelState extends State<MateriMapel> {
        ...
        body: Padding(
          ...
          child: jsonString.isEmpty
              ...
              : jsonString.isNotEmpty
                  ? GridMapel(jsonString, _kelas_id.toString(), widget.materi)
                  : Center(
                      child: CircularProgressIndicator(
                        color: Colors.orange[600],
                      ),
